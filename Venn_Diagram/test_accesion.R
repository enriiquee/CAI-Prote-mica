  ...
  repeat{
    ...
    if (x=="yes" | x==1 | x=="Yes")  {
      ...
      if (length(files_glob_no_control) == 1){ 
        ...
        df1 <- read_excel(file.path(getwd(), control[1]))
